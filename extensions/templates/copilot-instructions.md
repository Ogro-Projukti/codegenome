...
1. **Mandatory MCP Usage**: When `.genome/watcher.db` exists and the MCP server is healthy, you MUST use the Codegenome MCP server at `http://127.0.0.1:{{MCP_PORT}}/mcp` for all codebase, architecture, dependency, or symbol queries.
